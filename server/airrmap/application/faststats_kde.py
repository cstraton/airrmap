# Taken from https://raw.githubusercontent.com/mfouesneau/faststats/master/faststats/fastkde.py (MIT)
# Latest commit 9a75ac3 on 21 Nov 2019

# CS modifications:
# 28/06/21: Add @jit decorator.
# 09/05/21: Replaced 2x np.float with float (numpy deprecation warnings during testing).
