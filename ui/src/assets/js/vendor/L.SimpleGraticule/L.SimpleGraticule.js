/**
 *  Adapted from https://github.com/ablakey/Leaflet.SimpleGraticule
 *  BSD-2 License.
 ...
 * 
 *  Modifications:
 *  Added lineStyle.pane option to keep grid lines on top of other layers.
 */
 L.SimpleGraticule = L.LayerGroup.extend({
  ...
  lineStyle: {
      ...
      pane: 'simple-graticule-pane' // added
  },
